...
public class CompNFLTalent implements Comparator<Player> {
    ...
    public int compare(Player a, Player b) {
        ...
        a.talentNFL = ((5 * a.ratOvr + 2 * a.ratPot + a.character + a.ratDurability + a.ratIntelligence) / 10) + 3*a.getGamesStarted()/2;
        b.talentNFL = ((5 * b.ratOvr + 2 * b.ratPot + b.character + b.ratDurability + b.ratIntelligence) / 10) + 3*b.getGamesStarted()/2;
